Feature: Ensure Site Owners can create, edit and delete pages, editors can edit pages, ensure site owners and editors can access manage page
  In order to ensure that a site owners can create, edit and delete pages and editors can edit pages, and both site owners and editors can manaage pages
  As a site owner
