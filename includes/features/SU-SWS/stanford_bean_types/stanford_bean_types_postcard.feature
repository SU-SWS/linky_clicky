...
Feature: Stanford postcard bean Type
  ...
  Scenario: Create stanford postcard block
    And I am on "block/add/stanford-postcard"
    Then I fill "edit-label" with "Behat Postcard Block"
    Then I fill "edit-title" with "Behat Postcard Block"
    ...
    Then I press "Delete"
    Then I shold see "stanford_postcard Behat Postcard Block has been deleted."
