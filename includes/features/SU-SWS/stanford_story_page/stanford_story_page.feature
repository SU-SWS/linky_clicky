...
Feature: Stanford Paragraph Types
  ...
  Scenario: Create a Stanford Story Page with Teaser Cards Type
    ...
    # First Card.
    Then I attach the file "features/stanford_page/img/ooooaaaahhh.jpg" to "files[field_s_story_sections_und_0_field_p_cards_card_und_0_field_p_card_image_und_0]"
    ...
    And I attach the file "features/stanford_page/img/ooooaaaahhh.jpg" to "files[field_s_story_sections_und_0_field_p_cards_card_und_1_field_p_card_image_und_0]"
  ...
  Scenario: Create a Stanford Story Page with Hero Type
    ...
    Then I attach the file "features/stanford_page/img/ooooaaaahhh.jpg" to "files[field_s_story_sections_und_0_field_p_hero_image_und_0]"
