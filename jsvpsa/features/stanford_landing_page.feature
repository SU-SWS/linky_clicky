Feature: Stanford Landing Page
  In order to ensure that the Stanford Landing Page content type and supporting functionality works.
  As an end user and administrator
  I want to check for both the creation and display of the landing page content.
