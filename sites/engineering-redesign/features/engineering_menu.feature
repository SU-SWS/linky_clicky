Feature: Stanford School of Engineering Menus
  ...
  Scenario: Verify that we have the correct Students & Academics navigation items
    ...
    Then I should be on "students-academics/support-and-resources/technical-communication-program"
    ...
    When I click "SETS and Faculty-led programs"
    ...
    When I click "Research Opportunities"
    Then I should be on "students-academics/global-engineering-programs/research"
