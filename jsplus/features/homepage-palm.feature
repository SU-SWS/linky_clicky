...
#  Given the "stanford_jumpstart_home_palm_news_events" homepage layout is not selected
  ...
  When I press the "edit-layouts-stanford-jumpstart-home-palm-news-events-selecter" button
...
Scenario Outline: Header content
  ...
  Examples:
  | Header                | Region                |
  | Welcome to your site! | Content Top           |
...
Scenario Outline: Homepage content
  ...
  Examples:
  | Text                     | Region        |
  | Edit this block to change the image and caption. Keep text this short! | Content Top |
