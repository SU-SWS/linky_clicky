Feature: Stanford Video
  ...
  Scenario: Create Uploaded Video Node with Captions
    ...
    And I attach the file "features/img/media.mp4" to "edit-field-stanford-video-file-und-0-upload"
    And I attach the file "features/img/media.srt" to "edit-field-stanford-video-caption-und-0-upload"
    And I attach the file "features/img/keyframe.jpg" to "edit-field-stanford-video-poster-und-0-upload"
