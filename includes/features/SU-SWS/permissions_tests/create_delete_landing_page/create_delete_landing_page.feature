Feature: Ensure Site Owners can create and delete pages
  In order to ensure that a site owners can create, edit and delete landing pages
  As a site owner
  ...
  Scenario: Create, edit, then delete landing page
