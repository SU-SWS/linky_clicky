Feature: Ensure Site Users can view, select, and reset the filter by related content section on the news page
  In order to ensure that any site user can view, select, and reset the filter by related content section on the news page
  As a Site User
  I want to be able to view, select, and reset the filter by related content section on the news page

  @safe @javascript
  Scenario: Verify users can view the filter by related content section on the news page
