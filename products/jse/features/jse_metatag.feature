Feature: Ensure Site Owners can create, edit and delete metatags. Ensure editors can create, edit and delete metatags
  In order to ensure that site owners can create, edit and delete metatags
  As a site owner
  I want to be able create, edit and delete metatags
  As an editor
  I want to be able to edit metatags
  ...
  @api @dev @destructive @javascript
  Scenario: Ensure Editors can create, edit and delete their own metatags
  ...
  @api @dev @destructive @javascript
  Scenario: Ensure Editors can edit and delete any metatag
  Given I am logged in as a user with the "site owner" role
  And I am on "admin/config/search/metatags"
  Then I should see "Metatag" in the "Branding" region
  When I click "Add default meta tags"
  ...
  @api @dev @destructive @javascript
  Scenario: Ensure Site Owners can edit and delete any metatag
  Given I am logged in as a user with the "site owner" role
  And I am on "admin/config/search/metatags"
  Then I should see "Metatag" in the "Branding" region
  When I click "Add default meta tags"
