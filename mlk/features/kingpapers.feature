...
Scenario: King Papers Volumes Field
  Given I am logged in as a user with the "site owner" role
  And I am on "node/1379/edit"
  Then I should see “no” radio button checked in the “King Papers Volumes” field

Scenario: Click through to publication
  Given I am on “Resource Publications”
  When I click “The Martin Luther King, Jr., Encyclopedia” in the “Content Body” region
  Then I should see “In 1985 Coretta Scott King” in the “Content Body” region
