Feature: Feeds JSONPath Parser
  ...
  Scenario: Feeds JSONPath Parser
    ...
    And I enter "Feeds JSONPath Parser Test" for "Name"
    And I press the "Create" button
    And I go to "admin/structure/feeds/feeds_jsonpath_parser_test/settings/FeedsNodeProcessor"
    And I select "Basic page" from "Bundle"
    And I press the "Save" button
    And I go to "admin/structure/feeds/feeds_jsonpath_parser_test/parser"
    And I select the radio button "Select" with the id "edit-plugin-key--4"
    And I press the "Save" button
    And I go to "admin/structure/feeds/feeds_jsonpath_parser_test/settings/FeedsJSONPathParser"
    Then I should see "Settings for JSONPath parser"
    When I go to "admin/structure/feeds/feeds_jsonpath_parser_test/mapping"
    ...
    When I go to "admin/structure/feeds/feeds_jsonpath_parser_test/settings/FeedsJSONPathParser"
    And I enter "$.store.book.*" for "Context"
    And I enter "description" for "body"
    And I press the "Save" button
    Then I should see " Your changes have been saved"
    When I go to "admin/structure/feeds/feeds_jsonpath_parser_test/delete"
    And I press the "Delete" button
    Then I should be on "admin/structure/feeds"
    And I should not see "Feeds JSONPath Parser Test"
