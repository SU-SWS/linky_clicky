Feature: Ensure Site Owners can create, edit and delete metatags
  ...
  When I click on the element with css selector "a[href*='/admin/config/search/metatags/config/node%3Astanford_page']"
  ...
  And I click on the element with css selector "a[href*='/admin/config/search/metatags/config/node%3Astanford_page/delete']"
