Feature: Stanford News
  In order to ensure that the Stanford News content type and supporting functionality works.
  As an end user and administrator
  I want to check for both the creation and display of the news content.
